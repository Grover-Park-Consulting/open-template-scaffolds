...
**Building from a template?** This file decides what your tables, fields, queries, forms and
...
> the point of the standards/template split. You can also add to them here; **do so carefully
