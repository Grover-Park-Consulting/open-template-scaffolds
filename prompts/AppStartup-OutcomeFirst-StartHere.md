Build application startup and back-end relinking into my Access database using the outcome-first
method.
...
relative to that folder's root: templates/app-startup/app-startup-outcome-first.md (the template),
